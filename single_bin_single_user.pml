...
ltl door1 { [](change_bin?[OuterDoor, open] -> bin_status.trash_in_outer_door == 0) }
...
ltl door2 { [](change_bin?[LockOuterDoor, closed] -> (bin_status.trap_door == closed && bin_status.trash_on_trap_door == 0)) }
